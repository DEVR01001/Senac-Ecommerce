        ...
        <nav class="navbar navbar-expand-lg bg-body-tertiary" >
            ...
            <div class="collapse navbar-collapse" id="navbarText">
                ...
                <li class="nav-item mx-4">
                    <a class="nav-link fs-10" style="font-weight: 500;" aria-current="page" href="#">Home</a>
                </li>
                <li class="nav-item mx-4">
                    <a class="nav-link fs-10" style="font-weight: 500;" href="#">Favoritos</a>
                </li>
                <li class="nav-item mx-1">
                    <a class="nav-link fs-10" style="font-weight: 500;" href="#">
